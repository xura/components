...
export class TextInput extends CustomElement {
    ...
    render() {
        return html`<mwc-textfield @blur=${this.setValidityMessages} @input=${this.setValidityMessages} ?required="${this.required}" id='${this._identifier}' label="${this.label}"></mwc-textfield>`;
    }
}